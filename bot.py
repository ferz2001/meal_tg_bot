            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "Если на фото нет блюда, но есть дополнение, используй его чтобы вернуть ответ JSON."
                        "Преимущественно возвращай информацию, если можно это сделать по дополнению, чем вернуть Блюдо не найдено"
