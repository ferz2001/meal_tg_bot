    ...
    try:
            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "Также учитывай дополнительную информацию, переданную пользователем, касающуюся веса и состава блюда. "
                        f"Дополнение: {' '.join(message.caption.strip()[1:])}. "
                        "Если на фото нет блюда или информация о весе/составе неполная, используй данные, предоставленные пользователем. "
                        ...
                        "Если на фото нет блюда, верни строго: 'Блюдо не найдено'. "
                        "Если дополнение неполное или непонятное, используй информацию из фото и дополнительные замечания пользователя."
                    )
                },
                {
                    "role": "user",
        ...
        print({
                    ...
                    "content": (
                        ...
                        "Увеличивай калорийность на 50-100ккал, если она слишком низкая. "
                        "Также учитывай дополнительную информацию, переданную пользователем, касающуюся веса и состава блюда. "
                        f"Дополнение: {' '.join(message.caption.split(" ")[1:])}. "
                        "Если на фото нет блюда или информация о весе/составе неполная, используй данные, предоставленные пользователем. "
                        "Если в дополнении есть информация о весе, объёме и тд, при расчётах используй её преимущественно"
                        "Если распознано блюдо, верни только JSON формата:\n"
                        "{\n"
                        "  \"название\": \"string\",\n"
                        "  \"вес_г\": 16,\n"
