            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "Увеличивай калорийность на 50-100ккал"
                        "Также учитывай дополнение к фото, которое я пришлю ниже."
                        "Если не понятно что на фото, попробуй основываться на дополнении."
